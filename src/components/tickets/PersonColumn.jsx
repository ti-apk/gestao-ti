        ...
        >
            <div className="flex items-center gap-2 border-b border-border-light px-3 py-3 dark:border-border-dark">
                {person.photo ? (
                    ...
                    <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-brand-blue text-[9px] font-semibold text-white">
                        {person.initials}
                    </div>
                )}
            ...
            <div className="flex flex-1 flex-col gap-2 overflow-y-auto p-2.5">
                ...
                {tickets.length === 0 && (
                    <p className="py-6 text-center text-xs text-gray-400">Nenhum ticket</p>
                )}
            </div>
        </div>
    )
